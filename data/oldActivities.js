...
export const oldActivityData = [
  ...
  { // 1
    ...
    eventStartTime: new Date("2026-01-10T07:00:00"),
    hostId: 1,
    placeId: 1,
  ...
  { // 2
    ...
    eventStartTime: new Date("2026-03-25T21:00:00"), 
    hostId: 2, 
    placeId: 2, 
    coverPhoto: "https://images.unsplash.com/photo-1541625602330-2277a4c46182?q=80&w=1000",
    status: "FINISHED"
  },
  ...
  { // 3
    ...
    eventStartTime: new Date("2026-01-20T13:00:00"),
    hostId: 3,
    placeId: 3,
  ...
  { // 4
    ...
    eventStartTime: new Date("2026-04-15T20:00:00"),
    hostId: 4,
    placeId: 4,
    coverPhoto: "https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=1000",
    status: "FINISHED"
  },
  ...
  { // 5
    ...
    eventStartTime: new Date("2026-02-01T10:00:00"),
    hostId: 5,
    placeId: 5,
  ...
  { // 6
    ...
    eventStartTime: new Date("2026-02-28T15:00:00"),
    hostId: 6,
    placeId: 6,
    coverPhoto: "https://res.cloudinary.com/piecahcih/image/upload/v1776084374/Atln_bbgkgd.jpg",
    status: "FINISHED"
  },
  ...
  { // 7
    ...
    eventStartTime: new Date("2026-02-10T18:00:00"),
    hostId: 7,
    placeId: 7,
  ...
  { // 9
    ...
    eventStartTime: new Date("2026-03-10T08:00:00"), 
    hostId: 9, 
    placeId: 9, 
