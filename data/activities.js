export const activityData = [
  ...
  { // 11
    ...
    eventStartTime: new Date("2026-08-07T06:30:00"),
    hostId: 1,
    placeId: 1,
  },
  { // 12
    ...
    eventStartTime: new Date("2026-08-08T17:00:00"),
    hostId: 2,
    placeId: 2,
  },
  { // 13
    ...
    eventStartTime: new Date("2026-08-09T19:00:00"),
    hostId: 3,
    placeId: 2,
  },
  ...
  { // 14
    ...
    eventStartTime: new Date("2026-08-10T18:00:00"),
    isPublic: false,
    maxParticipants: 8,
    hostId: 3,
    placeId: 3,
  ...
  { // 15
    ...
    eventStartTime: new Date("2026-08-11T20:00:00"),
    isPublic: false,
    maxParticipants: 6,
    hostId: 4,
    placeId: 4,
  ...
  { // 16
    ...
    eventStartTime: new Date("2026-08-12T13:00:00"),
    hostId: 5,
    placeId: 5,
  },
  { // 17
    ...
    eventStartTime: new Date("2026-08-13T14:00:00"),
    hostId: 6,
    placeId: 6,
  },
  ...
  { // 18
    ...
    eventStartTime: new Date("2026-08-14T18:30:00"),
    hostId: 7,
    placeId: 7,
  },
  { // 19
    ...
    eventStartTime: new Date("2026-08-15T19:00:00"),
    hostId: 8,
    placeId: 8,
  },
  ...
  { // 20
    ...
    eventStartTime: new Date("2026-08-16T15:00:00"),
    hostId: 9,
    placeId: 9,
  },
  { // 21
    ...
    eventStartTime: new Date("2026-08-17T08:30:00"),
    maxParticipants: 12,
    hostId: 10,
    placeId: 10,
  },
  ...
  { // 22+1
    ...
    eventStartTime: new Date("2026-08-18T18:00:00"),
    eventEndTime: new Date("2026-08-18T20:00:00"),
    isPublic: false,
    maxParticipants: 8,
    hostId: 1,
    placeId: 3, 
  ...
  { // 23
    ...
    eventStartTime: new Date("2026-08-19T10:00:00"),
    hostId: 1,
    placeId: 12,
  },
  { // 24
    ...
    eventStartTime: new Date("2026-08-20T19:00:00"),
    maxParticipants: 5,
    hostId: 1,
    placeId: 19, 
  },
  { // 25
    ...
    eventStartTime: new Date("2026-08-21T19:30:00"),
    hostId: 1,
    placeId: 25, 
  },
  ...
  { // 26
    ...
    eventStartTime: new Date("2026-08-22T20:00:00"),
    hostId: 2,
    placeId: 15,
  },
  { // 27
    ...
    eventStartTime: new Date("2026-08-23T09:30:00"),
    isPublic: false,
    hostId: 2,
    placeId: 16,
  },
  { // 28
    ...
    eventStartTime: new Date("2026-08-24T18:30:00"),
    hostId: 2,
    placeId: 17,
  },
  { // 29
    ...
    eventStartTime: new Date("2026-08-25T19:00:00"),
    hostId: 2,
    placeId: 18,
  },
  ...
  { // 30
    ...
    eventStartTime: new Date("2026-08-26T19:30:00"),
    hostId: 3, 
    placeId: 11,
  },
  { // 31
    ...
    eventStartTime: new Date("2026-08-27T17:00:00"),
    hostId: 3,
    placeId: 13,
  },
  ...
  { // 32
    ...
    eventStartTime: new Date("2026-08-28T09:00:00"),
    eventEndTime: new Date("2026-08-28T15:00:00"),
    hostId: 4,
    placeId: 10, 
  },
  { // 33
    ...
    eventStartTime: new Date("2026-08-29T18:00:00"),
    maxParticipants: 4,
    hostId: 4,
    placeId: 4, 
  },
  ...
  { // 34
    ...
    eventStartTime: new Date("2026-08-30T13:00:00"),
    eventEndTime: new Date("2026-08-30T16:00:00"),
    maxParticipants: 8,
    hostId: 5,
    placeId: 5, 
  },
  { // 35
    ...
    eventStartTime: new Date("2026-08-31T17:30:00"),
    hostId: 5,
    placeId: 14,
  },
  { // 36
    ...
    eventStartTime: new Date("2026-09-01T18:30:00"),
    hostId: 5,
    placeId: 2, 
  },
  ...
  { // 37
    ...
    eventStartTime: new Date("2026-09-02T16:00:00"),
    hostId: 6,
    placeId: 9, 
  },
  { // 38
    ...
    eventStartTime: new Date("2026-09-03T15:00:00"),
    hostId: 6,
    placeId: 20, 
  },
  ...
  { // 39
    ...
    eventStartTime: new Date("2026-09-04T07:30:00"),
    maxParticipants: 6,
    hostId: 7,
    placeId: 8, 
  },
  { // 40
    ...
    eventStartTime: new Date("2026-09-05T16:00:00"),
    hostId: 7,
    placeId: 8, 
  },
  ...
  { // 41
    ...
    eventStartTime: new Date("2026-09-06T13:30:00"),
    hostId: 8,
    placeId: 3, 
  },
  { // 42
    ...
    eventStartTime: new Date("2026-09-07T18:00:00"),
    maxParticipants: 36,
    hostId: 8,
    placeId: 22, 
  },
  ...
  { // 43
    ...
    eventStartTime: new Date("2026-09-08T16:00:00"),
    hostId: 9,
    placeId: 1, 
  },
  { // 44
    ...
    coverPhoto: "https://res.cloudinary.com/piecahcih/image/upload/v1777140202/0ssyoga_nfvwiw.jpg",
    eventStartTime: new Date("2026-09-09T17:30:00"),
    maxParticipants: 36,
    hostId: 9,
    placeId: 14, 
  },
  ...
  { // 45
    ...
    eventStartTime: new Date("2026-09-10T11:00:00"),
    maxParticipants: 5,
    hostId: 10,
    placeId: 23, 
  },
  ...
  { // 46
    ...
    eventStartTime: new Date("2026-09-11T17:30:00"),
    hostId: 11,
    placeId: 18, 
  }
];